...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 18-Set-2019 às 17:02
...
(1, 1, 'aula 1', '2019-01-19', '20:00:00.000000', 'S', NULL, NULL),
(2, 2, 'reunião de pais ', '2019-02-15', '20:00:00.000000', 'S', NULL, NULL),
(3, 1, 'festa', '2019-02-02', '20:00:00.000000', 's', '2019-02-27 20:34:20', '2019-02-27 20:34:20');
...
(1, 'matematica', 'Curso fundamental para exercer atividades na tenda', 60, '2019-08-19 17:23:35', NULL),
(2, 'Portugues', 'estrutura', 60, '2019-08-19 17:23:48', '2019-02-02 03:42:52');
...
CREATE TABLE IF NOT EXISTS `entrada_estoque` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_individuo` (`id_responsavel`),
...
INSERT INTO `entrada_estoque` (`id`, `id_responsavel`, `quantidade`, `id_tipo_item`, `id_unidade_medida`, `data_entrada`) VALUES
(1, 1, 10, 1, 1, '2019-01-15'),
(2, 18, 50, 6, 1, '2019-08-06');
...
(1, 1, 'Carolina', 'Costa Figueredo', '38.970.313-8', '382.524.648-58', 'carolfig89@gmail.com', '11981677253', '(11)95178-1705', 'Rua Tomas Santa Rosa, 17', 'ermelino matarazzo', 'são pauo', 'SP', '03806-030', '1990-01-08', 'solteiro(a)', 'Analista de sistemas', NULL, NULL, NULL),
...
INSERT INTO `saida_estoque` (`id`, `quantidade`, `id_individuo`, `id_tipo_item`, `data`, `id_unidade_medida`) VALUES
(1, 10, 1, 5, '2019-08-07 00:00:00', 0);
...
INSERT INTO `unidade_medida` (`id`, `descricao`, `abreviatura`) VALUES
(1, 'Kilos', 'Kg'),
(2, 'Gramas', 'g'),
(3, 'unidades', 'Un');
...
(3, 'Claudia', 'claudia@tenda.com.br', NULL, '$2y$10$zfi/LISKAFNfqbixcgScn.we/kLH7IC8cZ.kxuR6jwmZnup7rPzfm', 'https://image.freepik.com/icones-gratis/pessoa-importante_318-10744.jpg', 'ofDqNkp7Hwq4MqHm165b9GVKtulZAk8CVvr2LobQjWbWLC3rRDuL3a1iCser', '2019-03-01 19:18:46', '2019-03-01 19:18:46'),
...
ALTER TABLE `entrada_estoque`
  ADD CONSTRAINT `entrada_estoque_ibfk_1` FOREIGN KEY (`id_responsavel`) REFERENCES `individuo` (`id`),
  ADD CONSTRAINT `entrada_estoque_ibfk_2` FOREIGN KEY (`id_tipo_item`) REFERENCES `tipo_item` (`id`),
  ADD CONSTRAINT `entrada_estoque_ibfk_3` FOREIGN KEY (`id_unidade_medida`) REFERENCES `unidade_medida` (`id`);
...
ALTER TABLE `saida_estoque`
  ADD CONSTRAINT `saida_estoque_ibfk_1` FOREIGN KEY (`id_individuo`) REFERENCES `individuo` (`id`),
  ADD CONSTRAINT `saida_estoque_ibfk_2` FOREIGN KEY (`id_tipo_item`) REFERENCES `tipo_item` (`id`);
